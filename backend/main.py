...
async def search_patients(
    ...
    if method == SearchMethod.PATIENT_ID:
    ...
    elif method == SearchMethod.PARTIAL_NAME:
    ...
    elif method == SearchMethod.NATIONAL_ID:
        for patient_id, patient in DEMO_PATIENTS.items():
...
async def get_patient_snapshot(patient_id: str, session: dict = Depends(verify_token)):
    ...
    if any(med["name"] == "Metformin" and allergy["substance"] == "Penicillin" 
